...
public class NativeFilters
{
     ...
     * @return 素描效果---铅笔画
     */
    public native int[] ToSketchPencil(int[] pixels, int width, int height, float factor);

    public native int[] ToSketch(int[] pixels, int width, int height, float factor);

    public native int[] ToColorSketch(int[] pixels, int width, int height, float factor);
